 ...
 */
public class BeforeYestodayOrdersFragment extends BaseFragment implements AdapterView.OnItemClickListener, OnOrdersChangeListener {
    BeforedayBinding b;
    ...
    public void onOrdersChange(FormlistDateBean orders) {
        allOrderdatas = orders.getData().get(0).getBefore_yesterday_order();
